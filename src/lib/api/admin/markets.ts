...
export function createAdminMatchEventBundle(
  payload: CreateMatchEventRequest,
  { token, signal }: ProtectedRequestOptions = {},
) {
  return apiRequest<EventMarketsResponse, CreateMatchEventRequest>({
    method: "POST",
...
export function getAdminMatchMarketCatalog(
  sportSlug: string,
  { token, signal }: ProtectedRequestOptions = {},
) {
  return apiRequest<MatchMarketCatalogResponse>({
    method: "GET",
...
export function updateAdminEventMatchup(
  eventId: string,
  payload: UpdateEventMatchupRequest,
  { token, signal }: ProtectedRequestOptions = {},
) {
  return apiRequest<EventDetailResponse, UpdateEventMatchupRequest>({
    method: "PATCH",
