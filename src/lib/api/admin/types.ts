...
export interface EventMatchParticipant {
  name: string;
...
export interface EventMatchup {
  ...
  status: string;
  home: EventMatchParticipant;
  away: EventMatchParticipant;
}

export interface MatchMarketGeneratedSelectionResponse {
  selection_key: string;
  label: string;
}

export interface MatchMarketTemplateResponse {
  template_key: string;
  market_key: string;
  label: string;
  description: string;
  ...
  generated_selections: MatchMarketGeneratedSelectionResponse[];
}

export interface MatchMarketCatalogResponse {
  sport_slug: string;
  templates: MatchMarketTemplateResponse[];
}
...
export interface CreateMatchEventChainRequest {
  neg_risk?: boolean;
...
export interface CreateMatchEventMarketsRequest {
  oracle_address: string;
  market_lock_at?: IsoDateString | null;
  template_selections?: CreateMatchMarketTemplateSelectionRequest[] | null;
  include_moneyline?: boolean;
  include_no_draw?: boolean;
  include_draw?: boolean;
  include_both_teams_to_score?: boolean;
  total_goals_lines?: string[];
  register_neg_risk?: boolean;
  additional_markets?: CreateEventMarketRequest[];
}

export interface CreateMatchMarketTemplateSelectionRequest {
  template_key: string;
  lines?: string[];
}
...
export interface CreateMatchEventRequest {
  event: CreateEventMetadataRequest;
  chain: CreateMatchEventChainRequest;
  markets: CreateMatchEventMarketsRequest;
  publish?: CreateEventPublishRequest;
}
...
export interface UpdateEventMatchupRequest {
