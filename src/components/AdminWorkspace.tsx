...
const marketCreationTypes: Array<{
  ...
  },
  {
    ...
    copy: "Create an event shell first, then add sibling markets or ladder markets under it.",
    available: true,
  },
  {
    id: "sports_match_market",
    title: "Sports match market",
    copy: "Create a Polymarket-style match event bundle with teams, status, and catalog-selected child markets.",
    available: true,
  },
  {
    id: "ladder_market",
    ...
    <Show when={props.open}>
      ...
      >
        ...
        <div class="pm-admin-drawer__identity">
          <span class="pm-market-chip">XLayer #{profile().xlayer_chain_id}</span>
